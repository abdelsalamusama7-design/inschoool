  ...
  const getMenuItems = (): MenuItem[] => {
    ...
    if (role === 'admin') {
      return [
        ...
        { title: 'الامتحانات', icon: FileText, url: '/dashboard/exams' },
        { title: 'نتائج الامتحانات', icon: BarChart3, url: '/dashboard/exam-results' },
        { title: 'إدارة الشهادات', icon: Award, url: '/dashboard/admin/certificates' },
